        ...
        {showCommitmentBox && (
          ...
          <div className="bg-[#EDF2FC] p-4 rounded-lg shadow-md border">
            ...
            <div className="flex flex-col gap-2 text-sm mb-4">
              <p>
                <span className="font-semibold">Maximum Commitment:</span> 100.0 USDT
              </p>
              <p>
                <span className="font-semibold">Minimum Commitment:</span> 10.0 USDT
              </p>
            </div>
          ...
          <div className="bg-[#EDF2FC] p-4 rounded-lg shadow-md border">
            ...
            <div className="flex flex-col gap-2 text-sm mb-4">
              ...
              <p>
                <span className="font-semibold">Amount to be received:</span> 50.0 USDT
              </p>
            </div>
