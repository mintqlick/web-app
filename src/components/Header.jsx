    ...
    >
      <div className="max-w-screen-xl w-full mx-auto px-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-x-8">
            ...
            <button className="px-4 py-2 text-[10px] w-[100px] h-[30px] border border-gray-800 rounded-full hover:bg-gray-100 transition">
              Login
            </button>
            <button className="px-4 py-2 text-[10px] w-[100px] h-[30px] bg-[#1860d9] text-white rounded-full hover:bg-[#164cb5] transition">
              Open Account
            </button>
          </nav>
      ...
      {isMenuOpen && (
        ...
        >
          ...
          <button className="w-full border border-gray-800 rounded-full py-2 text-sm hover:bg-gray-100 transition duration-200">
            Login
          </button>
          <button className="w-full bg-[#1860d9] text-white rounded-full py-2 text-sm hover:bg-[#164cb5] transition duration-200">
            Open Account
          </button>
        </div>
      )}
